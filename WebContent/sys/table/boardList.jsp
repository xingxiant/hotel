...
<link rel="${pageContext.request.contextPath }/sys/stylesheet" type="text/css" href="${pageContext.request.contextPath }/sys/style/css/index_1.css" />
</head>
<body>
<!-- 页面标题 -->
<div id="TitleArea">
    ...
    <table class="MainArea_Content" cellspacing="0" cellpadding="0">
        ...
        <tbody id="TableData">
		    <c:choose >
		    	...
		    	<c:otherwise>
		    	    <tr>
		    			<td colspan="5">没有你要找的数据，请先保存数据再查看！</td>
		    		</tr>
		    	</c:otherwise>
		    </c:choose>
